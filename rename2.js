/**
 * 更新日期：2026年6月1日（修改版：默认开启 flag 和 nf）
 * 用法：Sub-Store 脚本操作添加
 * 参数说明：详见原脚本注释
 *
 * 修改说明：
 * - [flag] 默认开启，无需书写；若需关闭，请使用 flag=false（暂不支持，建议直接删除该参数）
 * - [nf]   默认开启，无需书写；若需关闭，请使用 nf=false
 * - [name=] 仍需要显式提供值，否则不加前缀
 * - 其他参数默认关闭
 */

const inArg = $arguments;

// 修改点：nf 和 addflag 默认改为 true
